...
<div class="inline-flex flex-wrap justify-center">
  {#each services as service}
    <a
      class="flex w-6 h-6 p-[2px] mr-1 transition transform rounded hocus:scale-125 hocus:text-gray-100 focus-outline bg-gray-200 text-gray-500  {service.color}"
      href={service.url}
      target="_blank"
